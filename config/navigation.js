...
(function(){
  ...
  var NAV_ICONS = {
    ...
    clock: '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M8.25 21h7.5a1.5 1.5 0 001.342-2.173l-3.75-9a1.5 1.5 0 00-2.684 0l-3.75 9A1.5 1.5 0 008.25 21zM12 9v6m3-4.5l-3 6" /></svg>',
