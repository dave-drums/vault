...
(function(){
  ...
  var NAV_ICONS = {
    ...
    clock: '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M8.25 20.25h7.5c1.243 0 2.25-1.007 2.25-2.25v-1.5c0-.621-.504-1.125-1.125-1.125H7.125C6.504 15.375 6 15.879 6 16.5V18c0 1.243 1.007 2.25 2.25 2.25zM9.75 7.5h4.5l1.5 7.875H8.25L9.75 7.5zM12 6v1.5m0 0l5.25 6" /></svg>',
