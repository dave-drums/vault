...
Promise.all([
  ...
  var lastLessonTitle = mostRecent ? mostRecent.title : 'Resume Last Lesson';
      ...
      sidebar.innerHTML = 
        ...
        '    <a href="/progress" class="sidebar-link"><span class="nav-icon">' + NAV_ICONS.chart + '</span><span>My Progress</span></a>' +
  ...
  var lastLessonTitle = mostRecent ? mostRecent.title : 'Resume Last Lesson';
      ...
      menu.innerHTML = 
        ...
        '    <a href="/progress" class="vault-menu-link"><span class="nav-icon">' + NAV_ICONS.chart + '</span><span>My Progress</span></a>' +
