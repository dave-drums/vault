        ...
        <div className="metronome-card" style={{ background: '#fff', borderRadius: '15px', padding: '30px', boxShadow: '0 4px 12px rgba(0, 0, 0, 0.1)', border: '1px solid #e9ecef' }}>
          <div className="bpm-display" style={{ background: 'linear-gradient(135deg, #06b3fd, #38bdf8)', borderRadius: '15px', padding: '20px', marginBottom: '24px', boxShadow: '0 4px 12px rgba(6,179,253,0.3)' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '8px' }}>
              ...
              <button onClick={handleTapTempo} onMouseDown={() => setTapPressed(true)} onMouseUp={() => setTapPressed(false)} onMouseLeave={() => setTapPressed(false)} style={{ width: '45px', height: '45px', background: tapPressed ? '#fff' : '#daf4ff', borderRadius: '10px', border: '2px solid #fff', display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer', transition: 'all 0.2s ease', transform: tapPressed ? 'translateY(2px)' : 'translateY(0)' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <button onMouseDown={() => { setMinusPressed(true); handleBpmButtonDown(-5); }} onMouseUp={() => setMinusPressed(false)} onMouseLeave={() => setMinusPressed(false)} style={{ width: '45px', height: '45px', background: minusPressed ? '#fff' : '#daf4ff', borderRadius: '10px', border: '2px solid #fff', fontSize: '24px', fontWeight: '600', color: minusPressed ? '#06b3fd' : '#fff', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', transition: 'all 0.2s ease', transform: minusPressed ? 'translateY(2px)' : 'translateY(0)' }}>−</button>
              <div style={{ flex: '1' }}><input type="range" min="40" max="240" value={bpm} onChange={(e) => setBpm(parseInt(e.target.value))} style={{ width: '100%', height: '8px', borderRadius: '4px', background: '#daf4ff', outline: 'none', cursor: 'pointer', WebkitAppearance: 'none', appearance: 'none' }} /></div>
              <button onMouseDown={() => { setPlusPressed(true); handleBpmButtonDown(5); }} onMouseUp={() => setPlusPressed(false)} onMouseLeave={() => setPlusPressed(false)} style={{ width: '45px', height: '45px', background: plusPressed ? '#fff' : '#daf4ff', borderRadius: '10px', border: '2px solid #fff', fontSize: '24px', fontWeight: '600', color: plusPressed ? '#06b3fd' : '#fff', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', transition: 'all 0.2s ease', transform: plusPressed ? 'translateY(2px)' : 'translateY(0)' }}>+</button>
            </div>
          </div>
