        ...
        <div className="metronome-card" style={{ background: '#fff', borderRadius: '15px', padding: '30px', boxShadow: '0 4px 12px rgba(0, 0, 0, 0.1)', border: '1px solid #e9ecef' }}>
          <div className="bpm-display" style={{ background: 'linear-gradient(135deg, #06b3fd, #38bdf8)', borderRadius: '15px', padding: '20px', marginBottom: '24px', boxShadow: '0 4px 12px rgba(6,179,253,0.3)' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <button onMouseDown={() => { setMinusPressed(true); handleBpmButtonDown(-5); }} onMouseUp={() => setMinusPressed(false)} onMouseLeave={() => setMinusPressed(false)} style={{ width: '45px', height: '45px', background: '#fff', borderRadius: '10px', border: '2px solid #fff', fontSize: '24px', fontWeight: '600', color: '#06b3fd', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', transition: 'all 0.2s ease', transform: minusPressed ? 'translateY(2px)' : 'translateY(0)' }}>−</button>
              ...
              <button onMouseDown={() => { setPlusPressed(true); handleBpmButtonDown(5); }} onMouseUp={() => setPlusPressed(false)} onMouseLeave={() => setPlusPressed(false)} style={{ width: '45px', height: '45px', background: '#fff', borderRadius: '10px', border: '2px solid #fff', fontSize: '24px', fontWeight: '600', color: '#06b3fd', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', transition: 'all 0.2s ease', transform: plusPressed ? 'translateY(2px)' : 'translateY(0)' }}>+</button>
            </div>
          </div>
