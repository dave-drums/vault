  ...
  return React.createElement('div', { className: "metronome-wrapper", style: { minHeight: '60vh', background: '#f8f9fa', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '40px 20px', fontFamily: "'Inter', sans-serif" }},
    ...
    React.createElement('div', { style: { width: '100%', maxWidth: '600px' }},
      React.createElement('div', { className: "metronome-card", style: { background: '#fff', borderRadius: '15px', padding: '30px', boxShadow: '0 4px 12px rgba(0, 0, 0, 0.1)', border: '1px solid #e9ecef' }},
        React.createElement('div', { className: "bpm-display", style: { background: 'linear-gradient(135deg, #06b3fd, #38bdf8)', borderRadius: '15px', padding: '20px', marginBottom: '24px', boxShadow: '0 4px 12px rgba(6,179,253,0.3)' }},
          React.createElement('div', { style: { display: 'flex', justifyContent: 'space-between', marginBottom: '8px' }},
            ...
            React.createElement('button', { 
              ...
              style: { width: '45px', height: '45px', background: tapPressed ? '#fff' : '#7dd3fc', borderRadius: '10px', border: tapPressed ? '2px solid #fff' : '2px solid #06b3fd', display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer', transition: 'all 0.2s ease', transform: tapPressed ? 'translateY(2px)' : 'translateY(0)' }
            },
              React.createElement('svg', { viewBox: "0 0 32 32", xmlns: "http://www.w3.org/2000/svg", style: { width: '22px', height: '22px', fill: '#06b3fd' }},
          ...
          React.createElement('div', { style: { display: 'flex', alignItems: 'center', gap: '12px' }},
            ...
            React.createElement('div', { style: { flex: '1' }},
              React.createElement('input', { type: "range", min: "40", max: "240", value: bpm, onChange: (e) => setBpm(parseInt(e.target.value)), style: { width: '100%', height: '8px', borderRadius: '4px', background: '#7dd3fc', outline: 'none', cursor: 'pointer', WebkitAppearance: 'none', appearance: 'none' }})
            ),
            React.createElement('button', { 
        ...
        React.createElement('button', { onClick: () => setIsPlaying(!isPlaying), style: { width: '100%', padding: '16px', borderRadius: '10px', fontSize: '16px', fontWeight: '600', cursor: 'pointer', transition: 'all 0.2s ease', border: isPlaying ? '2px solid #06b3fd' : 'none', background: isPlaying ? 'rgba(6,179,253,0.15)' : 'linear-gradient(135deg, #06b3fd, #38bdf8)', color: isPlaying ? '#06b3fd' : '#fff', boxShadow: '0 4px 12px rgba(6,179,253,0.3)', fontFamily: "'Inter', sans-serif", marginBottom: '24px' }}, isPlaying ? formatTime(elapsedTime) : '▶ Start'),
